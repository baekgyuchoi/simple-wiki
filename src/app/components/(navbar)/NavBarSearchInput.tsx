    ...
    <div className="flex flex-col justify-center w-full rounded p-2 transition ">
      <div className="relative w-full">
        <input
          ...
          className="w-full bg-white text-white placeholder-white border border-white bg-opacity-50 px-5 py-2 sm:px-5 sm:py-3 font-mono w-full flex-1  hover:bg-gray-200 hover:bg-opacity-20 focus:bg-gray-200 focus:bg-opacity-20 rounded-full placeholder:text-base"
